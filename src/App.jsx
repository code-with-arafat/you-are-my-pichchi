    ...
    return (
      <div className="app">
        <div className="page entrance-page">
          ...
          <h1>এই পিচ্চি শুনো না একটা কথা বলি 🥺❤️</h1>
          
          <p>
            তোমার সাথে কিছু কথা ছিল যেগুলা হইতো কখনো বলা হয়নি...
            <br />
            একটু সময় নিয়ে শেষ পর্যন্ত দেখো কিন্তু! 😊
          </p>
      ...
      <div className="success-page">
        ...
        <div className="success-card">
          ...
          <p>
            ...
            <br />
            দেখি এই অপেক্ষার পহর আর কত লম্বা হয়!🥺
          </p>
        ...
        <div className="page first-page">
          ...
          <div className="first-story">
            ...
            <p className="special-line">
              আর আমি তোমার সেই পিচ্চি
              মায়াবী কণ্ঠের মায়ায়ই পড়লাম। 🥺❤️
            </p>
